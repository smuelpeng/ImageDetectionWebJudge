...
<html lang="en">
    ...
    <body>
        ...
        <form action="/evaluate" method="post" enctype="multipart/form-data">
          ...
          % for k,v in submit_params.iteritems():
        ...
        <p class='info'>Dataset files of this Standalone: <a href='gt/images.zip'>Images</a> - <a href='gt/gt.zip'>Ground Truth</a> <button class="ml20 pure-button pure-button-secondary" type="button" onclick="instructions()" >See upload instructions..</button></p>
        <%
        if len(subm_data)>0:
            graphicRows = []
            graphic2Rows = []
        ...
        <table class='results ib'>
            ...
            <% 
             ...
             for k,v in method_params.iteritems():
                num_column+=1
                if v['grafic'] == "1":
            ...
            base64Data = graphicData.encode('base64')
            graphic2Data = "[" + ','.join(graphic2Rows) + "]"
            base64Data2 = graphic2Data.encode('base64')
