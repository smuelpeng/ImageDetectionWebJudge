...
ClassVisualization.prototype.load_visualization = function(){
    ...
    var template = "<div class='im_filters'><input type='checkbox' checked='checked' id='chk_image'><label for='chk_image'>Show Image</label></div>"+
                   ...
                   "<div id='div_matrices'><div class='div_table'><h3>Matrix</h3>loading..</div></div>"+
    ...
    if(numDet>100){
        ...
        html_precision += "</tr></thead><tbody id='tbody_recall'>";
    ...
    $("#div_matrices").html("<div class='div_table'><h3>Recall Matrix</h3>" + html_recall + "</div><div class='div_table'><h3>Precision Matrix</h3>" + html_precision + "</div>");
    var evalLog = sampleData.evaluationLog;
    if (evalLog==undefined){
        evalLog = "";
    }
    $("#div_logs").html("<div class='div_log'><h3>Evaluation Log</h3>" + evalLog.replace(new RegExp("\n", 'g'),"<br/>") + "</div>");
